...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-InputMask', __webpack_require__(3));
    Vue.component('detail-InputMask', __webpack_require__(6));
    Vue.component('form-InputMask', __webpack_require__(9));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_the_mask__ = __webpack_require__(18);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    directives: {
        mask: __WEBPACK_IMPORTED_MODULE_1_vue_the_mask__["mask"]
    },
    computed: {
        setMask: function setMask() {
            return this.field.mask.split(",");
        }
    },
    methods: {
        /*
        ...
        fill: function fill(formData) {
            ...
            if (this.field.raw) {
                for (var i = 0; i < this.field.mask.length; i++) {
