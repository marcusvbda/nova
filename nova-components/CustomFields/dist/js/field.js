...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-CustomFields', __webpack_require__(3));
    Vue.component('detail-CustomFields', __webpack_require__(6));
    Vue.component('form-CustomFields', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        processed_field: function processed_field() {
            var _this = this;

            var field = this.field;
            var value = this.field.values.find(function (x) {
                return x.custom_field_id == _this.field.field_id;
            });
            if (!value) field.value = "";else field.value = value.value || '';
            return field;
        }
    }
});
...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(_vm.processed_field.value))])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        processed_field: function processed_field() {
            ...
            var value = this.field.values[this.field.field_id];
            field.value = value || '';
            return field;
        }
    }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("panel-item", { attrs: { field: _vm.processed_field } })
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
    ...
    [
      _c("template", { slot: "field" }, [
        _vm.field.type == "select"
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.field.type === "checkbox" && _vm.field.type == "text"
          ? _c("input", {
              directives: [
                {
                  name: "model",
          ...
          : _vm.field.type === "radio" && _vm.field.type == "text"
          ? _c("input", {
              directives: [
                {
                  name: "model",
              ...
              staticClass: "w-full form-control form-input form-input-bordered",
              class: _vm.errorClasses,
              attrs: { id: "text", placeholder: _vm.field.name, type: "radio" },
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.field.type === "checkbox" && _vm.field.type == "number"
          ? _c("input", {
              directives: [
                {
                  name: "model",
          ...
          : _vm.field.type === "radio" && _vm.field.type == "number"
          ? _c("input", {
              directives: [
                {
                  name: "model",
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.field.type === "checkbox" && _vm.field.type == "email"
          ? _c("input", {
              directives: [
                {
                  name: "model",
          ...
          : _vm.field.type === "radio" && _vm.field.type == "email"
          ? _c("input", {
              directives: [
                {
                  name: "model",
